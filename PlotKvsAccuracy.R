setwd("/Users/bthj/Documents/ITU/DataMining/IndividualAssignment/DataMiningIndividual")
...
k_vs_accuracy <- read.table("kVSaccuracy__age_programmingSkill_yearsAtUni_attribute.tab")
